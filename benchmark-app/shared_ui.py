...
def render_missing_data_warning_and_benchmark_button(
    ...
    # TODO: once the button is clicked, the user should not be able to change the selection anymore.
    # TODO: add a button to stop the benchmark and go back to the selection page.
