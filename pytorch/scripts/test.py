...
Usage:
    python test.py --run-dir <path/to/run_directory>

Example: (Assuming run in the pytorch/scripts directory)
    python test.py --run-dir ../runs/RotatedSurfaceCode_Phenomenological/d=5_rounds=5_basis=Z/MultiDMemBP/run_0

The run directory must contain config.yaml and checkpoints/best_model.ckpt (saved during training).
"""
...
def main():
    ...
    parser.add_argument("--run-dir", required=True, type=str, help="Path to run directory")
